...
//
//  double head = atan2(m.magnetic.y, m.magnetic.x);
...
// in the top-right corner of the application.
  ...
  Serial.print("Raw:");
  Serial.print((int)round(a.acceleration.x*100));
  Serial.print(',');
  Serial.print((int)round(a.acceleration.y*100));
  Serial.print(',');
  Serial.print((int)round(a.acceleration.z*100));
  Serial.print(',');
  Serial.print((int)round(m.magnetic.x*900));
  Serial.print(',');
  Serial.print((int)round(m.magnetic.y*900));
  Serial.print(',');
  Serial.print((int)round(m.magnetic.z*900));
  Serial.print(',');
  Serial.print((int)round(g.gyro.x*16));
  Serial.print(',');
  Serial.print((int)round(g.gyro.y*16));
  Serial.print(',');
  Serial.print((int)round(g.gyro.z*16));
  Serial.println();  
  delay(50);
}
